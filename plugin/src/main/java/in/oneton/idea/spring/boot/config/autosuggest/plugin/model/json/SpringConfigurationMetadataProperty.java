...
import static in.oneton.idea.spring.boot.config.autosuggest.plugin.model.ValueType.parse;
...
public class SpringConfigurationMetadataProperty
  ...
  public String getDocumentationForKey(MetadataNode propertyNode) {
    ...
    if (defaultValue != null) {
      builder.append("<p><em>Default value: </em>").append(defaultValue).append("</p>");
    }
